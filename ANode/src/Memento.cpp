...
BOOST_CLASS_EXPORT_IMPLEMENT(NodeQueueMemento);
BOOST_CLASS_EXPORT_IMPLEMENT(NodeGenericMemento);
BOOST_CLASS_EXPORT_IMPLEMENT(NodeQueueIndexMemento);
...
BOOST_CLASS_EXPORT_IMPLEMENT(NodeRepeatIndexMemento);
