...
public:
   ...
   bool set_memento(const NodeTodayMemento* ,std::vector<ecf::Aspect::Type>& aspects,bool);
   bool set_memento(const NodeTimeMemento* ,std::vector<ecf::Aspect::Type>& aspects,bool);
   bool set_memento(const NodeDayMemento* ,std::vector<ecf::Aspect::Type>& aspects,bool);
   bool set_memento(const NodeCronMemento* ,std::vector<ecf::Aspect::Type>& aspects,bool);
   bool set_memento(const NodeDateMemento* ,std::vector<ecf::Aspect::Type>& aspects,bool);
