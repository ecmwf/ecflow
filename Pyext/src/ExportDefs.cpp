...
void export_Defs()
{
   ...
   .def("find_node_path",        &Defs::find_node_path,"Given a type and a name, return path of the first match, otherwise return an empty string")
   .def("find_node",             &Defs::find_node,"Given a type and a path to a node, return the node.")
