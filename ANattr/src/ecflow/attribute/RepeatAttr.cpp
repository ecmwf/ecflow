...
CEREAL_REGISTER_DYNAMIC_INIT(RepeatDate)
CEREAL_REGISTER_DYNAMIC_INIT(RepeatDateList)
CEREAL_REGISTER_DYNAMIC_INIT(RepeatInteger)
CEREAL_REGISTER_DYNAMIC_INIT(RepeatEnumerated)
CEREAL_REGISTER_DYNAMIC_INIT(RepeatString)
CEREAL_REGISTER_DYNAMIC_INIT(RepeatDay)

CEREAL_REGISTER_POLYMORPHIC_RELATION(RepeatBase, RepeatDate)
CEREAL_REGISTER_POLYMORPHIC_RELATION(RepeatBase, RepeatDateList)
CEREAL_REGISTER_POLYMORPHIC_RELATION(RepeatBase, RepeatInteger)
CEREAL_REGISTER_POLYMORPHIC_RELATION(RepeatBase, RepeatEnumerated)
CEREAL_REGISTER_POLYMORPHIC_RELATION(RepeatBase, RepeatString)
CEREAL_REGISTER_POLYMORPHIC_RELATION(RepeatBase, RepeatDay)
