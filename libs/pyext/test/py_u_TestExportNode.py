...
class TestNodeVec:
    ...
    def test_getitem_returns_correct_node(self):
        ...
        nv.append(t1)
        nv.append(t2)
        assert nv[0].name() == "alpha"
        assert nv[1].name() == "beta"
...
class TestNode:
    ...
    def test_rshift_second_child_has_trigger_on_first(self):
        ...
        assert t2.get_trigger() is not None
        expr = t2.get_trigger().get_expression()
        assert "t1" in expr
        assert "complete" in expr
    ...
    def test_lshift_first_child_gets_trigger_on_second(self):
        ...
        assert t1.get_trigger() is not None
    ...
    def test_getattr_resolves_variable(self):
        ...
        result = t.MY_VAR
        assert isinstance(result, ecf.Variable)
    ...
    def test_getattr_resolves_event(self):
        ...
        t.add_event("done")
        result = t.done
        assert isinstance(result, ecf.Event)
    ...
    def test_getattr_resolves_meter(self):
        ...
        result = t.progress
        assert isinstance(result, ecf.Meter)
    ...
    def test_getattr_resolves_limit(self):
        ...
        result = t.myLimit
        assert isinstance(result, ecf.Limit)
    ...
    def test_remove_detaches_from_parent(self):
        ...
        s = d.add_suite("s1")
        t = s.add_task("t1")
        assert t.get_parent().name() == "s1"
        t.remove()
        assert t.get_parent() is None
    ...
    def test_add_trigger_by_str_sets_expression(self):
        ...
        assert "t2" in t.get_trigger().get_expression()
    ...
    def test_add_complete_by_str_sets_expression(self):
        ...
        assert t.get_complete() is not None
        assert "t2" in t.get_complete().get_expression()
    ...
    def test_add_defstatus_by_dstate(self):
        ...
        assert ret is t
        assert t.get_defstatus() == ecf.DState.complete
    ...
    def test_add_defstatus_by_defstatus_object(self):
        ...
        assert ret is t
        assert t.get_defstatus() == ecf.DState.suspended

    def test_get_defstatus_default_is_queued(self):
        """A fresh task has defstatus == queued."""
        t = ecf.Task("t1")
        assert t.get_defstatus() == ecf.DState.queued
    ...
    def test_add_autocancel_by_days(self):
        ...
        assert ret is t
        assert t.get_autocancel() is not None
    ...
    def test_get_autocancel_returns_none_when_not_set(self):
        ...
        t = ecf.Task("t1")
        assert t.get_autocancel() is None
    ...
    def test_add_autoarchive_by_days(self):
        ...
        assert ret is t
        assert t.get_autoarchive() is not None
    ...
    def test_get_autoarchive_returns_none_when_not_set(self):
        ...
        t = ecf.Task("t1")
        assert t.get_autoarchive() is None
    ...
    def test_add_autorestore_by_object(self):
        ...
        assert ret is t
        assert t.get_autorestore() is not None
    ...
    def test_get_autorestore_returns_none_when_not_set(self):
        ...
        t = ecf.Task("t1")
        assert t.get_autorestore() is None
    ...
    def test_get_state_fresh_task_returns_state(self):
        ...
        t = ecf.Task("t1")
        state = t.get_state()
        assert isinstance(state, ecf.State)
    ...
    def test_get_state_in_defs_is_unknown(self):
        ...
        assert t.get_state() == ecf.State.unknown
    ...
    def test_get_dstate_in_defs_is_unknown(self):
        ...
        s = d.add_suite("s1")
        t = s.add_task("t1")
        assert t.get_dstate() == ecf.DState.unknown
    ...
    def test_get_flag_returns_flag_object(self):
        ...
        assert isinstance(flag, ecf.Flag)
