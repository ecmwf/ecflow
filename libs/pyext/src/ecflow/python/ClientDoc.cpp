...
const char* ClientDoc::query() {
    return "Query the status of event, meter, state, variable, limit, limit_max or trigger expression without "
           "blocking\n\n"
           "- state,     return :code:`unknown` | :code:`complete` | :code:`queued` | :code:`aborted` | "
           ":code:`submitted` | :code:`active` to standard out\n"
           "- dstate,    return :code:`unknown` | :code:`complete` | :code:`queued` | :code:`suspended` | "
           ":code:`aborted` | :code:`submitted` | :code:`active` to standard out\n"
           ...
           "       res = ci.query('dstate','/path/to/node')                       # return node state as a string, can "
           "include suspended\n"
           "   except RuntimeError, e:\n"
           "       print str(e)\n";
}
