...
public:
    ...
    NodeTreeTraverser& operator=(const NodeTreeTraverser&) = delete;
    NodeTreeTraverser(NodeTreeTraverser&&)                 = delete;
    NodeTreeTraverser& operator=(NodeTreeTraverser&&)      = delete;
