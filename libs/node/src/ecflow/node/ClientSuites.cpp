...
#include "ecflow/node/ClientSuites.hpp"
...
ClientSuites::ClientSuites(Defs* defs,
                           unsigned int handle,
...
void ClientSuites::collateChanges(DefsDelta& changes, const ecf::AuthorisationContext& ctx) const {
