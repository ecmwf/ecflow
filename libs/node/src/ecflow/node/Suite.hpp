...
private:
    ...
    mutable SuiteGenVariables* suite_gen_variables_{
        nullptr}; // NOT persisted can be generated by calling update_generated_variables()
    bool begun_{false};
...
private:
    ...
    mutable Variable genvar_dirname_;    // *NOT* persisted, can be generated by calling update_generated_variables()
    mutable Variable genvar_basename_;   // *NOT* persisted, can be generated by calling update_generated_variables()
