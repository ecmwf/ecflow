...
public:
    ...
    void setStateOnlyHierarchically(NState::State s, const ecf::AuthorisationContext& ctx, bool force = false) override;
    void set_state_hierarchically(NState::State s, bool force) override;
    void set_state_hierarchically(NState::State s, const ecf::AuthorisationContext& ctx, bool force) override;
