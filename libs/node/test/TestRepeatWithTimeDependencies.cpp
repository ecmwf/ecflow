...
BOOST_AUTO_TEST_CASE(test_repeat_day_time_combination_in_hierarchy) {
    ...
    boost::posix_time::ptime expected_time1 =
        boost::posix_time::ptime(date(2019, 8, 5), time_duration(10, 0, 0)); // Monday & 10
    boost::posix_time::ptime expected_time2 =
        boost::posix_time::ptime(date(2019, 8, 5), time_duration(11, 0, 0)); // Monday & 11
    boost::posix_time::ptime expected_time3 =
        boost::posix_time::ptime(date(2019, 8, 12), time_duration(10, 0, 0)); // Monday & 10
    boost::posix_time::ptime expected_time4 =
        boost::posix_time::ptime(date(2019, 8, 12), time_duration(11, 0, 0)); // Monday & 11
    // cout << defs << "\n";
...
BOOST_AUTO_TEST_CASE(test_repeat_time_day_combination_in_hierarchy) {
    ...
    CalendarUpdateParams calUpdateParams(hours(1));
    boost::posix_time::ptime expected_time1 =
        boost::posix_time::ptime(date(2019, 8, 5), time_duration(0, 0, 0)); // Monday & 00:00
    boost::posix_time::ptime expected_time3 =
        boost::posix_time::ptime(date(2019, 8, 12), time_duration(0, 0, 0)); // Monday & 00:00
    // cout << defs << "\n";
