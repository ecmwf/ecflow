...
struct Stats
{
    ...
    bool has_user_commands_server() const;
    bool has_task_commands() const;
    bool has_user_commands_zombie() const;
    bool has_user_commands_node() const;
    bool has_user_commands_file() const;
    ...
    std::unique_ptr<ecf::resources::ProcessMeter> process_meter_;
