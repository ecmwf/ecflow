...
#ifndef ecflow_core_test_harness_TestSerialisation_HPP
#define ecflow_core_test_harness_TestSerialisation_HPP
...
#endif /* ecflow_core_test_harness_TestSerialisation_HPP */
