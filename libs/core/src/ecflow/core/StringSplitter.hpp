...
#ifndef ecflow_core_StringSplitter_HPP
...
//
// Will split a string. Will return an empty std::string_view if there is a separator at the end.
...
#endif /* ecflow_core_StringSplitter_HPP */
