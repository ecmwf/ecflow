...
const char* NodeAttrDoc::cron_doc()
{
   return
            ...
            "   cron.set_days_of_month( [10,12] )\n"
            "   cron.set_months( [10,11] )\n"
            "   cron.set_time_series( TimeSlot(10,10) )\n"
            ;
}
...
const char* NodeAttrDoc::clock_doc()
{
   return
            ...
            "      bool hybrid<optional>: Default = True, true means hybrid, false means real\n"
            "                             by default the clock is not virtual\n\n"
