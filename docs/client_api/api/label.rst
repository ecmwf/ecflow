...
.. rubric:: Output of :code:`--help=label`



The following help text is generated by :code:`ecflow_client --help=label`
...
.. seealso::
   ...
   :ref:`Protocol reference for LabelCmd <proto_LabelCmd>` — the request/reply
