...
( "help,h",
         ...
         "  This environment variable is specifically to handle case c/  and *only* when job generation > 60 seconds\n"
         ...
         "  Additional information is also output helping to determine the cause.(i.e for case c/)\n"
         ...
         "  export ECF_PROFILE_THRESHOLDS=suite:2500,family:1000,task:100\n"
         "\n"
