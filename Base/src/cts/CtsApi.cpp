...
std::string CtsApi::server_version() {
    return std::string("--server_version");
}
const char* CtsApi::server_version_arg() {
...
const char* CtsApi::get_state_arg() {
    return "get_state";
}
...
const char* CtsApi::migrate_arg() {
    return "migrate";
}

std::string CtsApi::stats() {
    return "--stats";
}
const char* CtsApi::statsArg() {
    return "stats";
}
std::string CtsApi::stats_server() {
    return "--stats_server";
}
const char* CtsApi::stats_server_arg() {
    return "stats_server";
}
std::string CtsApi::stats_reset() {
    return "--stats_reset";
}
const char* CtsApi::stats_reset_arg() {
    return "stats_reset";
}

std::string CtsApi::suites() {
    return "--suites";
}
const char* CtsApi::suitesArg() {
    return "suites";
}

std::vector<std::string>
CtsApi::ch_register(int client_handle, bool auto_add_new_suites, const std::vector<std::string>& suites) {
...
const char* CtsApi::ch_register_arg() {
    return "ch_register";
}

std::string CtsApi::ch_suites() {
    return "--ch_suites";
}
const char* CtsApi::ch_suites_arg() {
    return "ch_suites";
}
...
const char* CtsApi::ch_drop_user_arg() {
    return "ch_drop_user";
}
...
const char* CtsApi::ch_remove_arg() {
    return "ch_rem";
}
...
const char* CtsApi::ch_auto_add_arg() {
    return "ch_auto_add";
}

std::vector<std::string>
CtsApi::sync(unsigned int client_handle, unsigned int state_change_no, unsigned int modify_change_no) {
    std::vector<std::string> retVec;
    retVec.reserve(3);
    std::string ret = "--sync=";
    ret += ecf::convert_to<std::string>(client_handle);
...
std::vector<std::string>
CtsApi::sync_clock(unsigned int client_handle, unsigned int state_change_no, unsigned int modify_change_no) {
    std::vector<std::string> retVec;
    retVec.reserve(3);
...
std::vector<std::string>
CtsApi::news(unsigned int client_handle, unsigned int state_change_no, unsigned int modify_change_no) {
    std::vector<std::string> retVec;
    retVec.reserve(3);
    std::string ret = "--news=";
    ret += ecf::convert_to<std::string>(client_handle);
...
std::vector<std::string> CtsApi::loadDefs(const std::string& filePath, bool force, bool check_only, bool print) {
    ...
    if (check_only)
        retVec.emplace_back("check_only");
    if (print)
        retVec.emplace_back("print");
    return retVec;
}
const char* CtsApi::loadDefsArg() {
    return "load";
}

std::string CtsApi::restartServer() {
    return "--restart";
}
const char* CtsApi::restartServerArg() {
    return "restart";
}

std::string CtsApi::haltServer(bool auto_confirm) {
    return (auto_confirm) ? "--halt=yes" : "--halt";
}
const char* CtsApi::haltServerArg() {
    return "halt";
}

std::string CtsApi::shutdownServer(bool auto_confirm) {
    return (auto_confirm) ? "--shutdown=yes" : "--shutdown";
}
const char* CtsApi::shutdownServerArg() {
    return "shutdown";
}

std::string CtsApi::terminateServer(bool auto_confirm) {
    return (auto_confirm) ? "--terminate=yes" : "--terminate";
}
const char* CtsApi::terminateServerArg() {
    return "terminate";
}

std::string CtsApi::pingServer() {
    return "--ping";
}
const char* CtsApi::pingServerArg() {
    return "ping";
}
...
const char* CtsApi::server_load_arg() {
    return "server_load";
}

std::string CtsApi::debug_server_on() {
    return "--debug_server_on";
}
const char* CtsApi::debug_server_on_arg() {
    return "debug_server_on";
}
std::string CtsApi::debug_server_off() {
    return "--debug_server_off";
}
const char* CtsApi::debug_server_off_arg() {
    return "debug_server_off";
}
...
const char* CtsApi::checkJobGenOnlyArg() {
    return "checkJobGenOnly";
}
...
const char* CtsApi::edit_history_arg() {
    return "edit_history";
}
...
const char* CtsApi::whyArg() {
    return "why";
}

std::string CtsApi::zombieGet() {
    return "--zombie_get";
}
const char* CtsApi::zombieGetArg() {
    return "zombie_get";
}

std::vector<std::string>
CtsApi::zombieFob(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password) {
    std::string ret = "--zombie_fob=";
    std::vector<std::string> retVec;
    retVec.reserve(paths.size() + 3);
    if (!paths.empty())
        ret += paths[0];
    retVec.push_back(ret);
    for (size_t i = 1; i < paths.size(); i++)
        retVec.push_back(paths[i]);
    if (!process_id.empty())
...
std::string CtsApi::zombieFobCli(const std::string& path) {
    std::string ret = "--zombie_fob=";
    ret += path;
    return ret;
}
std::vector<std::string> CtsApi::zombieFobCli(const std::vector<std::string>& paths) {
    std::string ret = "--zombie_fob";
    std::vector<std::string> retVec;
    retVec.reserve(paths.size() + 1);
    retVec.push_back(ret);
    std::copy(paths.begin(), paths.end(), std::back_inserter(retVec));
    return retVec;
}
const char* CtsApi::zombieFobArg() {
    return "zombie_fob";
}

std::vector<std::string>
CtsApi::zombieFail(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password) {
...
std::string CtsApi::zombieFailCli(const std::string& path) {
    std::string ret = "--zombie_fail=";
    ret += path;
    return ret;
}
...
const char* CtsApi::zombieFailArg() {
    return "zombie_fail";
}

std::vector<std::string>
CtsApi::zombieAdopt(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password) {
...
std::string CtsApi::zombieAdoptCli(const std::string& path) {
    std::string ret = "--zombie_adopt=";
    ret += path;
    return ret;
}
...
const char* CtsApi::zombieAdoptArg() {
    return "zombie_adopt";
}

std::vector<std::string> CtsApi::zombieRemove(const std::vector<std::string>& paths,
...
std::string CtsApi::zombieRemoveCli(const std::string& path) {
    std::string ret = "--zombie_remove=";
    ret += path;
    return ret;
}
...
const char* CtsApi::zombieRemoveArg() {
    return "zombie_remove";
}

std::vector<std::string>
CtsApi::zombieBlock(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password) {
...
std::string CtsApi::zombieBlockCli(const std::string& path) {
    std::string ret = "--zombie_block=";
    ret += path;
    return ret;
}
...
const char* CtsApi::zombieBlockArg() {
    return "zombie_block";
}

std::vector<std::string>
CtsApi::zombieKill(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password) {
...
std::string CtsApi::zombieKillCli(const std::string& path) {
    std::string ret = "--zombie_kill=";
    ret += path;
    return ret;
}
...
const char* CtsApi::zombieKillArg() {
    return "zombie_kill";
}
...
std::vector<std::string> CtsApi::order(const std::string& absNodePath, const std::string& orderType) {
    std::vector<std::string> retVec;
    retVec.reserve(2);
    std::string ret = "--order=";
    ret += absNodePath;
    retVec.push_back(ret);
    retVec.push_back(orderType);
    return retVec;
}
const char* CtsApi::orderArg() {
    return "order";
}
...
std::vector<std::string> CtsApi::replace(const std::string& absNodePath,
    ...
    std::string ret = "--replace=";
    ret += absNodePath;
    retVec.push_back(ret);
    retVec.push_back(path_to_client_defs);
    if (create_parents_as_required)
        retVec.emplace_back("parent");
    if (force)
        retVec.emplace_back("force");

    return retVec;
}
const char* CtsApi::replace_arg() {
    return "replace";
}
...
const char* CtsApi::checkPtDefsArg() {
    return "check_pt";
}

std::string CtsApi::restoreDefsFromCheckPt() {
    return "--restore_from_checkpt";
}
const char* CtsApi::restoreDefsFromCheckPtArg() {
    return "restore_from_checkpt";
}
...
std::vector<std::string> CtsApi::force(const std::vector<std::string>& paths,
    ...
    std::string ret = "--force=";
    ret += state_or_event;
    retVec.push_back(ret);
    if (recursive)
        retVec.emplace_back("recursive");
    if (set_repeats_to_last_value)
        retVec.emplace_back("full");
    std::copy(paths.begin(), paths.end(), std::back_inserter(retVec));
    return retVec;
}
...
const char* CtsApi::forceArg() {
    return "force";
}

std::vector<std::string>
CtsApi::freeDep(const std::vector<std::string>& paths, bool trigger, bool all, bool date, bool time) {

    std::vector<std::string> retVec;
    retVec.reserve(paths.size() + 4);

    retVec.emplace_back("--free-dep");
    if (all)
        retVec.emplace_back("all");
    else {
        if (trigger)
            retVec.emplace_back("trigger");
        if (date)
            retVec.emplace_back("date");
        if (time)
            retVec.emplace_back("time");
    }
    std::copy(paths.begin(), paths.end(), std::back_inserter(retVec));
    return retVec;
}
...
const char* CtsApi::freeDepArg() {
    return "free-dep";
}

std::vector<std::string>
CtsApi::file(const std::string& absNodePath, const std::string& fileType, const std::string& max_lines) {
    std::vector<std::string> retVec;
    retVec.reserve(3);
    std::string ret = "--file=";
    ret += absNodePath;
...
const char* CtsApi::plugArg() {
    return "plug";
}

std::vector<std::string> CtsApi::alter(const std::vector<std::string>& paths,
                                       const std::string& alterType,
                                       const std::string& attrType,
                                       const std::string& name,
                                       const std::string& value) {
    std::vector<std::string> retVec;
    retVec.reserve(5 + paths.size());
...
std::vector<std::string> CtsApi::alter(const std::string& path,
                                       const std::string& alterType,
                                       const std::string& attrType,
                                       const std::string& name,
                                       const std::string& value) {
...
std::vector<std::string>
CtsApi::alter_sort(const std::vector<std::string>& paths, const std::string& sortable_attribute_name, bool recursive) {
    std::vector<std::string> retVec;
    retVec.reserve(2 + paths.size());
...
const char* CtsApi::alterArg() {
    return "alter";
}

std::string CtsApi::reloadwsfile() {
    return "--reloadwsfile";
}
const char* CtsApi::reloadwsfileArg() {
    return "reloadwsfile";
}

std::string CtsApi::reloadpasswdfile() {
    return "--reloadpasswdfile";
}
const char* CtsApi::reloadpasswdfile_arg() {
    return "reloadpasswdfile";
}

std::string CtsApi::reloadcustompasswdfile() {
    return "--reloadcustompasswdfile";
}
const char* CtsApi::reloadcustompasswdfile_arg() {
    return "reloadcustompasswdfile";
}
...
std::vector<std::string> CtsApi::new_log(const std::string& new_path) {
    ...
    if (!new_path.empty())
        retVec.push_back(new_path);
    return retVec;
}
std::string CtsApi::clearLog() {
    return "--log=clear";
}
std::string CtsApi::flushLog() {
    return "--log=flush";
}
std::string CtsApi::get_log_path() {
    return "--log=path";
}

std::string CtsApi::forceDependencyEval() {
    return "--force-dep-eval";
}
const char* CtsApi::forceDependencyEvalArg() {
    return "force-dep-eval";
}

std::vector<std::string> CtsApi::edit_script(const std::string& path_to_task,
    ...
    if (!path_to_script.empty())
        retVec.push_back(path_to_script);
    if (create_alias)
        retVec.emplace_back("create_alias");
    if (!run)
        retVec.emplace_back("no_run");
    return retVec;
}
const char* CtsApi::edit_script_arg() {
    return "edit_script";
}
