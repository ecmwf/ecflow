...
public:
    ...
    static std::vector<std::string> loadDefs(const std::string& filePath,
                                             bool force,
                                             bool check_only,
                                             bool print); // check_only & print are client side only
    ...
    sync(unsigned int client_handle, unsigned int state_change_no, unsigned int modify_change_no);
    static std::vector<std::string>
    sync_clock(unsigned int client_handle, unsigned int state_change_no, unsigned int modify_change_no);
    static std::string sync_full(unsigned int client_handle);
    static std::vector<std::string>
    news(unsigned int client_handle, unsigned int state_change_no, unsigned int modify_change_no);

    static std::vector<std::string>
    ch_register(int client_handle, bool auto_add_new_suites, const std::vector<std::string>& suites);
    ...
    static std::vector<std::string>
    delete_node(const std::vector<std::string>& paths,
                bool force        = false,
                bool auto_confirm = true); // no paths specified ,delete all suites, for test
    static std::vector<std::string>
    delete_node(const std::string& absNodePath = "",
                bool force                     = false,
                bool auto_confirm              = true); // no node specified ,delete all suites, for test
    ...
    static std::vector<std::string>
    zombieFob(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password);
    static std::vector<std::string>
    zombieFail(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password);
    static std::vector<std::string>
    zombieAdopt(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password);
    static std::vector<std::string>
    zombieRemove(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password);
    static std::vector<std::string>
    zombieBlock(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password);
    static std::vector<std::string>
    zombieKill(const std::vector<std::string>& paths, const std::string& process_id, const std::string& password);
    ...
    static std::vector<std::string> replace(const std::string& absNodePath,
                                            ...
                                            bool force                      = false);
    static std::vector<std::string> requeue(const std::vector<std::string>& paths,
                                            const std::string& option /* [ "" | "force" | "abort" ] */);
    static std::vector<std::string> requeue(const std::string& absNodePath,
                                            const std::string& option /* [ "" | "force" | "abort" ] */);
    ...
    static std::string checkPtDefs(ecf::CheckPt::Mode m         = ecf::CheckPt::UNDEFINED,
                                   int check_pt_interval        = 0,
                                   int check_pt_save_time_alarm = 0);
    static std::string restoreDefsFromCheckPt();

    static std::vector<std::string> force(const std::vector<std::string>& paths,
                                          const std::string& state_or_event,
                                          bool recursive                 = false,
                                          bool set_repeats_to_last_value = false);
    static std::vector<std::string> force(const std::string& path,
                                          const std::string& state_or_event,
                                          bool recursive                 = false,
                                          bool set_repeats_to_last_value = false);

    static std::vector<std::string> freeDep(const std::vector<std::string>& paths,
                                            bool trigger = true,
                                            bool all     = false,
                                            bool date    = false,
                                            bool time    = false);
    static std::vector<std::string> freeDep(const std::string& absNodePath,
                                            bool trigger = true,
                                            bool all     = false,
                                            bool date    = false,
                                            bool time    = false);
    ...
    static std::vector<std::string>
    file(const std::string& absNodePath, const std::string& fileType, const std::string& max_lines);
    static std::vector<std::string> plug(const std::string& sourcePath, const std::string& destPath);

    static std::vector<std::string>
    alter(const std::string& path,
          const std::string& alterType, /* one of [ 'add' | 'change' | 'delete' | 'set_flag' | 'clear_flag' ] */
          const std::string& attrType,
          const std::string& name  = "",
          const std::string& value = "");
    static std::vector<std::string>
    alter(const std::vector<std::string>& paths,
          const std::string& alterType, /* one of [ 'add' | 'change' | 'delete' | 'set_flag' | 'clear_flag' ] */
          const std::string& attrType,
          const std::string& name  = "",
          const std::string& value = "");
    static std::vector<std::string>
    alter_sort(const std::vector<std::string>& paths, const std::string& sortable_attribute_name, bool recursive);
