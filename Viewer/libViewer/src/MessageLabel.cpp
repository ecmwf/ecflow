...
MessageLabelLoadWidget::MessageLabelLoadWidget(QWidget* parent) : QWidget(parent) {
    ...
    connect(loadCancelTb_, SIGNAL(clicked()), this, SLOT(cancelButtonClicked()));
}
...
MessageLabelProgWidget::MessageLabelProgWidget(QWidget* parent) : QWidget(parent) {
    ...
    connect(delayedProgressTimer_, SIGNAL(timeout()), this, SLOT(showDelayedProgress()));

    connect(progCancelTb_, SIGNAL(clicked()), this, SLOT(cancelButtonClicked()));
}
...
MessageLabel::MessageLabel(QWidget* parent) : QWidget(parent) {
    ...
    msgLabel_->setTextInteractionFlags(Qt::LinksAccessibleByMouse | Qt::TextSelectableByKeyboard |
    ...
    connect(loadWidget_, SIGNAL(stoppedByButton()), this, SIGNAL(loadStoppedByButton()));

    connect(progWidget_, SIGNAL(showInfoRequested(QString)), this, SLOT(showInfo(QString)));

    connect(progWidget_, SIGNAL(stoppedByButton()), this, SIGNAL(progressStoppedByButton()));
}
