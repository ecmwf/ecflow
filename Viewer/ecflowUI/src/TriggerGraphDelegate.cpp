...
TriggerGraphDelegate::TriggerGraphDelegate(QWidget *parent) :
...
TriggerGraphDelegate::~TriggerGraphDelegate()
= default;

void TriggerGraphDelegate::updateSettings()
{
    //Update the settings handled by the base class
    updateBaseSettings();
}

QSize TriggerGraphDelegate::sizeHint(const QStyleOptionViewItem&, const QModelIndex & index ) const
{
    return nodeBox_->sizeHintCache;
}

void TriggerGraphDelegate::paint(QPainter *painter,const QStyleOptionViewItem &option,
