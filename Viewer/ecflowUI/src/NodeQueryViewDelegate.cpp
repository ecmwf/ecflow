...
NodeQueryViewDelegate::~NodeQueryViewDelegate() = default;
...
void NodeQueryViewDelegate::paint(QPainter* painter,
...
void NodeQueryViewDelegate::renderNode(QPainter* painter,
