...
static QString
    tooltipUnchk("This panel is <b>linked</b> and will respond to selections made in other panels. Click to toggle.");
static QString tooltipChk(
    "This panel is <b>detached</b> and will not respond to selections made in other panels. Click to toggle.");

static QString
    tooltipMaxChk("This panel is <b>maximised</b> and hides other panels. Click to restore its original size.");
...
DashboardWidget::DashboardWidget(const std::string& type, QWidget* parent)
    ...
    connect(detachedAction_, SIGNAL(toggled(bool)), this, SLOT(slotDetachedToggled(bool)));
    ...
    connect(maximisedAction_, SIGNAL(toggled(bool)), this, SLOT(slotMaximisedToggled(bool)));
