...
#ifndef ecflow_viewer_SessionHandler_HPP
#define ecflow_viewer_SessionHandler_HPP
...
public:
    ...
    static std::string
    sessionDirName(const std::string& sessionName); // static because they are called from the constructor
    static std::string
    sessionQtDirName(const std::string& sessionName); // static because they are called from the constructor
...
#endif /* ecflow_viewer_SessionHandler_HPP */
