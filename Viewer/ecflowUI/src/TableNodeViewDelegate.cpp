...
TableNodeViewDelegate::TableNodeViewDelegate(QWidget* /*parent*/) : borderPen_(QPen(QColor(230, 230, 230))) {
...
TableNodeViewDelegate::~TableNodeViewDelegate() = default;
...
void TableNodeViewDelegate::paint(QPainter* painter,
...
void TableNodeViewDelegate::renderNode(QPainter* painter,
