...
(char*) " !! (NODE& ADMIN, ALL,'Forcex', MENU) ",
...
(char*) " menu 'Web' ",
(char*) " { ",
(char*) " (TASK, ALL, 'Man', 'sh firefox <full_name> %MANPATH%', '', YES) ",
(char*) " (TASK, ALL, 'Script', 'sh echo xterm -e vim <full_name>:%ECF_SCRIPT% ', '', YES) ",
(char*) " (TASK, ALL, 'Job', 'sh echo xterm -e vim <full_name>:%ECF_JOB% ', '', YES) ",
(char*) " (TASK, ALL, 'Output', 'sh echo xterm -e vim <full_name>:%ECF_JOBOUT% ', '', YES) ",
...
(char*) " menu 'Forcex' ",
(char*) " { ",
(char*) " (TASK, ~UNKNOWN, 'Unknown', 'ecflow_client --force <full_name> unknown', '',YES) ",
(char*) "  ",
(char*) " (TASK, ~COMPLETE, 'Complete', 'ecflow_client --force complete <full_name>', ",
(char*) " 'Have you tried the new menu <Set complete>',YES) ",
(char*) "  ",
(char*) " (TASK, ~QUEUED, 'Queued', 'ecflow_client --force queued <full_name>', ",
(char*) " 'Have you tried the new menu <Rerun>',YES) ",
(char*) "  ",
(char*) " (TASK, ~SUBMITTED,'Submitted','ecflow_client --force submitted <full_name>','',YES) ",
(char*) " (TASK, ~ACTIVE, 'Active', 'ecflow_client --force active <full_name>', '',YES) ",
(char*) " (TASK, ~ABORTED, 'Aborted', 'ecflow_client --force aborted <full_name>', '',YES) ",
(char*) " } ",
(char*) "  ",
(char*) " !============================================================================== ",
(char*) " ! Suite submenu ",
...
(char*) " menu \"Special\" ",
(char*) " { ",
(char*) " !! ((SUITE|FAMILY) & (COMPLETE|QUEUED|SUSPENDED) & ~MIGRATED,ALL,'Migrate', ",
(char*) " !! 'ecflow_client --migrate <full_name>','',NO) ",
(char*) " !! ((SUITE|FAMILY) & MIGRATED,ALL,'Restore', ",
(char*) " !! 'ecflow_client --restore_from_checkpt <full_name>','',YES) ",
(char*) " (SUITE|FAMILY,(ACTIVE|SUBMITTED|ABORTED),'Kill', ",
(char*) " 'ecflow_client --kill <full_name>','',YES) ",
...
(char*) "  ",
(char*) " ! (ALL,ALL,'-',SEPARATOR) ",
(char*) " ! ((SUITE|FAMILY) & ADMIN, SELECTION, 'Plug into selected node', PLUG) ",
...
(char*) " ! (SERVER|SUITE, ALL , 'Extra', MENU ) ",
(char*) " } ",
(char*) "  ",
(char*) " menu \"Extra\" ",
(char*) " { ",
