...
(char*) " (NODE& ADMIN, ALL,'Defstatus', MENU) ",
...
(char*) " menu \"Forcex\" ",
(char*) " { ",
(char*) " (TASK, ALL, 'AbortedFree', 'ecflow_client --force aborted <full_name>; ecflow_client --alter add variable ECF_PASS FREE <full_name>') ",
(char*) " } ",
(char*) "  ",
(char*) " menu \"Force\" ",
(char*) " { ",
